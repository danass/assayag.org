...
export const Remind = () => {
    ...
    const [telegramSel, setegramSel] = useState(false)
                    ...
                    return <section className="event-container" style={{
                        ...
                        <div className="event">
                            ...
                            <div className="event-wrapper">
                                ...
                                {eSel == 0 || event.end == "" || toNow(event.end) <= 0 ? <div className={`"event-enddate" ${toNow(event.end) <= 0 ? "" : "event-ended"}`} >
