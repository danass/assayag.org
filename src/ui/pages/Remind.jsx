 ...
 return (
  <>
   ...
   <div onClick={() => {
    ...
    }} className={`remind-selector ${eSel == 0 ? "remind-selected" : ""}`}>{user? <div>All <i>(edit)</i></div> :<div>All</div>}  </div>
    ...
    {user ? <div onClick={() => { seteSel(3) }} className={`remind-selector ${eSel == 3 ? "remind-selected" : ""}`}>Private</div> : <div className="remind-disabled">Private</div>}
